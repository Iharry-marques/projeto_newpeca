// Em: frontend/src/pages/LoginPageSuno.jsx
...
export default function LoginPageSuno() {
  const handleLogin = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 p-4 sm:p-6 lg:p-8">
      <div className="relative z-10 w-full max-w-sm rounded-2xl border border-slate-200/80 bg-white p-8 text-center shadow-xl sm:p-10">
        ...
        <p className="mb-6 text-slate-500">Entre com sua conta Google Suno.</p>
        <button
          onClick={handleLogin}
          className="w-full transform rounded-xl bg-gradient-to-r from-[#ffc801] to-[#ffb700] px-4 py-3 font-semibold text-slate-900 shadow-sm transition-all duration-200 hover:scale-[1.02] hover:shadow-md focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2"
        >
          Entrar com Google
        </button>
      </div>

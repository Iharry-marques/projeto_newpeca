    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center justify-between md:justify-end gap-4">
              ...
              <button
                ...
                className="flex items-center justify-center px-4 py-2 text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-lg transition-colors"
                title="Sair"
              >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-12">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6 sm:p-8 mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-slate-800 mb-6">Resumo das Campanhas</h2>

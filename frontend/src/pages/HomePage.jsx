...
const FileViewer = ({
  ...
  return (
    <div className="relative" onClick={handleCardClick}>
      ...
      <div
        className={`bg-white rounded-2xl shadow-lg border-2 p-4 transition-all duration-300 ${
          isSelectionMode
            ? "cursor-pointer"
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-end space-x-4 p-6 bg-slate-50 rounded-b-2xl">
            ...
            <button
              type="submit"
              disabled={isCreating}
              className="px-6 py-2 bg-gradient-to-r from-[#ffc801] to-[#ffb700] text-white font-semibold rounded-lg hover:shadow-lg disabled:opacity-50 disabled:grayscale"
            >
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex flex-col sm:flex-row justify-center items-center gap-4">
        <label
          htmlFor="file-input"
          className={`inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#ffc801] to-[#ffb700] text-white font-semibold rounded-xl transition-all duration-200 ${
            disabled
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg mb-8 border border-slate-200">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="flex items-center px-6 py-3 bg-emerald-500 text-white font-semibold rounded-xl hover:bg-emerald-600 transition-all"
            >
          ...
          <>
            ...
            <div className="mt-8 bg-white p-8 rounded-2xl shadow-lg border border-slate-200">
              ...
              >
                <input
                  type="text"
                  value={newCreativeLineName}
                  onChange={(e) => setNewCreativeLineName(e.target.value)}
                  placeholder="Nome da nova pasta..."
                  className="flex-grow p-3 border border-slate-300 rounded-xl focus:border-[#ffc801] focus:ring-2 focus:ring-[#ffc801]/20 outline-none"
                />
                <button
                  type="submit"
                  className="flex-shrink-0 px-6 py-3 bg-emerald-500 text-white font-semibold rounded-xl hover:bg-emerald-600 transition-all"
                >
            ...
            <div className="mt-8">
              ...
              >
                <div className="flex flex-col items-center">
                  <div
                    className={`mx-auto w-16 h-16 bg-gradient-to-br from-[#ffc801] to-[#ffb700] rounded-full flex items-center justify-center mb-4 shadow-lg ${
                      !selectedCreativeLineId ? "grayscale" : ""
                    }`}
                  >
                  ...
                  <p className="text-slate-500 text-sm">
                    Arraste e solte os arquivos ou use os botões abaixo
                  </p>
                </div>
              </FileUpload>
            </div>
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  {!isSelectionMode ? (
                    <button
                      ...
                      className="flex items-center px-4 py-2 bg-white border border-slate-300 text-slate-600 font-semibold rounded-lg hover:bg-slate-50 transition-colors"
                    >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <button
                        ...
                        className="flex items-center px-4 py-2 bg-red-500 text-white font-semibold rounded-lg hover:bg-red-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        <Trash2 className="w-4 h-4 mr-2" />
